...
import web.filter.CustomZuulFilter;
...
public class WebServer {
	 ...
	 * doesn't matter.
	 */
    public String ACCOUNTS_SERVICE_URL = "http://ACCOUNTS-SERVICE";
    
    public String PRODUCTS_SERVICE_URL = "http://PRODUCTS_SERVICE";
	...
	//	return new WebAccountsService(ACCOUNTS_SERVICE_URL, PRODUCTS_SERVICE_URL);
	//}
	...
	@Bean
	public CustomZuulFilter myFilter() {
